...
namespace Core::Graphics::OpenGL {
    ...
    private:
        ...
        // GLuint program[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_alpha[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_nt[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_alpha_nt[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_vc[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_alpha_vc[IDX(IRenderer::FogState::MAX_COUNT)];
        // GLuint program_nt_vc[IDX(IRenderer::FogState::MAX_COUNT)];
    ...
    public:
        ModelSharedComponent(Device* p_device);
    ...
    public:
        Model(Device* p_device, ModelSharedComponent* p_model_shared, StringView path);
        ~Model();
    };
}
