...
namespace Core::Graphics::DX11
{
	...
	private:
		...
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> m_canvas_srv;
		Microsoft::WRL::ComPtr<ID3D11RenderTargetView> m_canvas_rtv;
		Microsoft::WRL::ComPtr<ID3D11DepthStencilView> m_canvas_dsv;
	private:
	...
	public:
		SwapChain(Window_Win32* p_window, Device* p_device);
		~SwapChain();
	public:
		static bool create(Window_Win32* p_window, Device* p_device, SwapChain** pp_swapchain);
	};
}
