...
#include "Core/Graphics/SDL_GPU/Device.hpp"
#include "Core/Graphics/SDL_GPU/Model.hpp"
...
namespace Core::Graphics::SDL_GPU {
	...
	public:
		SDL_GPUShader* GetShader() const noexcept { return m_shader; }
		void bind(void* engine_data, void* user_data);
	...
	public:
		PostEffectShader(Device* p_device, StringView path, bool is_path_);
		~PostEffectShader();
	};
	...
	private:
		ScopeObject<Device> m_device;
		ScopeObject<ModelSharedComponent> m_model_shared;

		SDL_GPUBuffer* _fx_vbuffer = nullptr;
		SDL_GPUBuffer* _fx_ibuffer = nullptr;
		...
		ScopeObject<Texture2D> _state_texture;
	...
	public:
		static bool create(Device* p_device, Renderer** pp_renderer);
	};
}
