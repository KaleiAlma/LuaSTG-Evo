...
namespace Core::Graphics::SDL_GPU {
    ...
    private:
        float const vertex_data[8] = {
            -1.f, 1.f,
            1.f, 1.f,
            1.f, -1.f,
            -1.f, -1.f,
        };
        int16_t const idx_data[6] = { 0, 1, 2, 0, 2, 3 };
    ...
    public:
        SwapChain(Window_SDL* p_window, Device* p_device);
        ~SwapChain();
    public:
        static bool create(Window_SDL* p_window, Device* p_device, SwapChain** pp_swapchain);
    };
}
