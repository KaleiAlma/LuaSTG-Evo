...
#include "Core/Graphics/Interface/Font.hpp"
...
namespace Core::Graphics {
	...
	public:
		TrueTypeGlyphManager(IDevice* p_device, TrueTypeFontInfo* p_arr_info, size_t info_count);
		~TrueTypeGlyphManager();
	};
