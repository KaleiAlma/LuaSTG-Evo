...
static struct InputEventListener : public Core::Graphics::IWindowEventListener {
    NativeWindowMessageResult onNativeWindowMessage(void* ev) {
        ...
        case SDL_EVENT_KEY_DOWN:
            LuaSTGPlus::lastKeyDown = e->key.key;
            break;
        case SDL_EVENT_KEY_UP:
            LuaSTGPlus::lastKeyUp = e->key.key;
            break;
...
namespace LuaSTGPlus {
    ...
    bool AppFrame::GetKeyState(int VKCode)noexcept {
        return SDL_GetKeyboardState(NULL)[SDL_GetScancodeFromKey(VKCode, NULL)];
    }
    ...
    inline Core::Vector2F MapLetterBoxingPosition(Core::Vector2U isize, Core::Vector2I osize, Core::Vector2F pos) {
