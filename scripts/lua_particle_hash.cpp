                ...
                case 'e':
                  switch(key[4]) {
                    case 'l':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle2DMember::accel;
                      }
                      break;
                  }
                  break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle2DMember::angle;
                      }
                      break;
                  }
                  break;
        ...
        case 'o':
          switch(key[2]) {
            case 's':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::Particle2DMember::pos;
              }
              break;
          }
          break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle2DMember::scale;
                      }
                      break;
                  }
                  break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'd':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle2DMember::speed;
                      }
                      break;
                  }
                  break;
        ...
        case 'e':
          switch(key[2]) {
            case 'l':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::Particle2DMember::vel;
              }
              break;
          }
          break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'l':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle3DMember::accel;
                      }
                      break;
                  }
                  break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle3DMember::angle;
                      }
                      break;
                  }
                  break;
        ...
        case 'o':
          switch(key[2]) {
            case 's':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::Particle3DMember::pos;
              }
              break;
          }
          break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle3DMember::scale;
                      }
                      break;
                  }
                  break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'd':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::Particle3DMember::speed;
                      }
                      break;
                  }
                  break;
        ...
        case 'e':
          switch(key[2]) {
            case 'l':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::Particle3DMember::vel;
              }
              break;
          }
          break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'l':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle2DMember::accel;
                      }
                      break;
                  }
                  break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle2DMember::angle;
                      }
                      break;
                  }
                  break;
        ...
        case 'o':
          switch(key[2]) {
            case 's':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::TexParticle2DMember::pos;
              }
              break;
          }
          break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle2DMember::scale;
                      }
                      break;
                  }
                  break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'd':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle2DMember::speed;
                      }
                      break;
                  }
                  break;
        ...
        case 'e':
          switch(key[2]) {
            case 'l':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::TexParticle2DMember::vel;
              }
              break;
          }
          break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'l':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle3DMember::accel;
                      }
                      break;
                  }
                  break;
        ...
        case 'o':
          switch(key[2]) {
            case 's':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::TexParticle3DMember::pos;
              }
              break;
          }
          break;
                ...
                case 'l':
                  switch(key[4]) {
                    case 'e':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle3DMember::scale;
                      }
                      break;
                  }
                  break;
                ...
                case 'e':
                  switch(key[4]) {
                    case 'd':
                      switch(key[5]) {
                        case '\0':
                          return LuaSTGPlus::TexParticle3DMember::speed;
                      }
                      break;
                  }
                  break;
        ...
        case 'e':
          switch(key[2]) {
            case 'l':
              switch(key[3]) {
                case '\0':
                  return LuaSTGPlus::TexParticle3DMember::vel;
              }
              break;
          }
          break;
