...
if(zlib_ng_ADDED AND minizip_ng_ADDED)
    ...
    #     IMPORTED_LOCATION         ${CMAKE_BINARY_DIR}/install/lib/zlibstatic-ng${CMAKE_STATIC_LIBRARY_SUFFIX}
    #     IMPORTED_LOCATION_DEBUG   ${CMAKE_BINARY_DIR}/install/lib/zlibstatic-ngd${CMAKE_STATIC_LIBRARY_SUFFIX}
    #     IMPORTED_LOCATION_RELEASE ${CMAKE_BINARY_DIR}/install/lib/zlibstatic-ng${CMAKE_STATIC_LIBRARY_SUFFIX}
    # )
